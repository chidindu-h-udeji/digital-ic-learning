...
module tb_id_ex_reg;
  ...
  logic [6:0]  funct7_in, funct7_out;
  ...
  initial begin
    ...
    pc_in = 32'h600D_CA5E; imm_ext_in = 32'hDACC9167; rs1_data_in = 32'hC00C_D1E7; rs2_data_in = 32'hFEED_D1E7; rs1_addr_in = 1; rs2_addr_in = 2; rd_addr_in = 3; funct3_in = 2; funct7_in = 6;
    ...
    pc_in = 32'hD0D0_B1DD; imm_ext_in = 32'hCA57_7EAA; rs1_data_in = 32'hC8D8_F868; rs2_data_in = 32'hB100_57A7; rs1_addr_in = 4; rs2_addr_in = 3; rd_addr_in = 2; funct3_in = 1; funct7_in = 0;
    reg_write_in = 1; alu_src_in = 1; mem_read_in = 1; mem_write_in = 1; mem_to_reg_in = 1; branch_in = 1;
    
    @(negedge clk); 
    if (pc_out !== 32'hD0D0_B1DD || imm_ext_out !== 32'hCA57_7EAA || rs1_data_out !== 32'hC8D8_F868 || rs2_data_out !== 32'hB100_57A7 || rs1_addr_out !== 4 || rs2_addr_out !== 3 || rd_addr_out !== 2 || funct3_out !== 1 || funct7_out !== 0 || {reg_write_out, alu_src_out, mem_read_out, mem_write_out, mem_to_reg_out, branch_out} !== 6'b111111) begin
    ...
    // SCENARIO 2: Stall
    stall = 1;
    pc_in = 32'hA5CE_DEAD; imm_ext_in = 32'hBEA7_4FEE; rs1_data_in = 32'h533D_5EED; rs2_data_in = 32'h2026_AD55; rs1_addr_in = 5; rs2_addr_in = 6; rd_addr_in = 7; funct3_in = 2; funct7_in = 3;
    ...
    if (pc_out !== 32'hD0D0_B1DD || imm_ext_out !== 32'hCA57_7EAA || rs1_data_out !== 32'hC8D8_F868 || rs2_data_out !== 32'hB100_57A7 || rs1_addr_out !== 4 || rs2_addr_out !== 3 || rd_addr_out !== 2 || funct3_out !== 1 || funct7_out !== 0) begin
