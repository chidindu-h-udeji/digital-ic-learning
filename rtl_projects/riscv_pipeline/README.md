...
├── id_stage/            # ID wrapper, control unit, immediate generator
├── ex_stage/            # EX stage (ALU, ALU control, branch comparator)
├── if_stage/            # PC logic, instruction memory, IF wrapper
